...
import 'package:shopzone/foodSeller/functions/food_functions.dart';
...
// Replace the Firestore update with HTTP POST request to your API
    final response = await http.post(
      Uri.parse(API.foodSellerSaveFcmToken),
      body: {
        'uid': sellerID,
  ...
  showNotificationWhenOpenApp(orderID, context) async {
    final response = await http.get(
      Uri.parse('${API.foodSellerGetOrderStatus}?orderID=$orderID'),
    );
