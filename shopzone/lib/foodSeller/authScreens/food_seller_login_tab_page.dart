...
import 'package:shopzone/foodSeller/widgets/food_seller_custom_text_field.dart';
import 'package:shopzone/foodSeller/widgets/food_seller_loading_dialog.dart';
  ...
  loginNow() async {
    ...
    try {
      var res = await http.post(
        Uri.parse(API.foodSellerLoginSeller),
        body: {
