...
import 'package:shopzone/user/foodUser/foodUserFunctions/functions.dart';
...
// Replace the Firestore update with HTTP POST request to your API
    final response = await http.post(
      Uri.parse(API.foodUserSaveFcmTokenUser),
      body: {
        'uid': userID,
        'token': "registrationDeviceToken",
      },
    );
    print("---------------------------------------------foodUserSaveFcmTokenUser------------------------------------------------------");
    print(API.foodUserSaveFcmTokenUser);
    print(userID);
